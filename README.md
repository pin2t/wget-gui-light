...
Серверная часть выполняет следующие задачи:
 ...
 - Получение списка истории (парсинг лог-файла);
 - Ведение логов;
...
`log_path` | Директория для лог-файлов серверной части. Возможен режим записи разных типов сообщений в разные файлы (устанавливаются в константах класса `log`).<br />По умолчанию запись всех сообщений происходит в файл `wgetgui.log`
